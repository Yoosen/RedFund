...
private struct JDFinanceLoginWebView: NSViewRepresentable {
    ...
    (function() {
      if (window.__redFundJDProbeInstalled) { return; }
      window.__redFundJDProbeInstalled = true;
      ...
      XMLHttpRequest.prototype.open = function(method, url) {
        this.__redFundJDProbeMethod = method || 'GET';
        this.__redFundJDProbeURL = url || '';
      ...
      XMLHttpRequest.prototype.send = function() {
        ...
        this.addEventListener('load', function() {
          ...
          post({
            source: 'xhr',
            url: this.responseURL || this.__redFundJDProbeURL || '',
            method: this.__redFundJDProbeMethod || 'GET',
            status: this.status,
            requestBody: requestBody,
