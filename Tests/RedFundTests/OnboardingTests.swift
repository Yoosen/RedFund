...
final class OnboardingTests: XCTestCase {
    ...
    func testFreshSettingsAreMarkedCreatedNewAndAwaitOnboarding() throws {
        ...
        XCTAssertEqual(AppSettings.currentSchemaVersion, 14)
    ...
    func testSampleExperienceIsDeterministicAndContainsOnlyFictionalData() throws {
        ...
        XCTAssertEqual(first.dailyPerformance.last?.date, Calendar.redFundChina.startOfDay(for: now))
    }
    ...
    private func temporaryDirectory() -> URL {
        FileManager.default.temporaryDirectory
            .appending(path: "red-fund-onboarding-test-\(UUID().uuidString)", directoryHint: .isDirectory)
    }
...
private extension Calendar {
    static var redFundChina: Calendar {
